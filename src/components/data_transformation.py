...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = ['fueltype', 'aspiration', 'carbody', 'drivewheel', 'enginetype','fuelsystem']
            numerical_cols = ['wheelbase', 'carlength', 'carwidth', 'carheight', 'curbweight','cylindernumber', 'enginesize', 'boreratio', 'stroke','compressionratio', 'horsepower', 'peakrpm', 'citympg', 'highwaympg','price']
    ...
    def initaite_data_transformation(self,train_path,test_path):
        try:
            ...
            drop_columns = [target_column_name,'car_ID','CarName', 'symboling', 'doornumber', 'enginelocation']
